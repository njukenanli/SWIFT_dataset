    ...
    with ThreadPoolExecutor(max_workers=2) as executor:
        ...
        for future in as_completed(future_to_instance):
            ...
            try:
                ...
                with write_lock:
                    with open("data/live/6_test_loc_context_api_injected.jsonl", "a") as f:
...
if __name__ == "__main__":
    ...
    if os.path.exists("data/live/6_test_loc_context_api_injected.jsonl"):
        with open("data/live/6_test_loc_context_api_injected.jsonl") as f:
